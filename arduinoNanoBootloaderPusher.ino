//Inspiration:  https://www.youtube.com/watch?v=vYLjDQKnapo

//Step 1 - Push this sketch to a bare Arduino Uno

//Step 2 - Disconnect the usb from the Uno

//Step 3 - Connect the two Arduinos.  Make sure you connect to the Nanos HEADER pins.  Not the pins on the outside of the board.
//Pin 1 of the NANO to D12 UNO
//Pin 2 of the NANO to 5V UNO
//Pin 3 of NANO D13 to the UNO
//Pin 4 NANO D11 to the UNO
//Pin 5 of the NANO to D10 UNO
//Pin 6 to GND NANO UNO

//Step 4 - Configure the Arduino IDE for bootloader recovery
//Board : Tools / boards / Arduino Nano 
//Processor: Tools / Processor / ATmega328
//Developer: Tools / Programmer / Arduino ISP
//
//Step 5 - Connect the Uno usb to the computer again

//Step 6 - Tools / Burn Bootloader

//You should now see the leds blink on both Arduinos.  Wait until the blinking stops.  
